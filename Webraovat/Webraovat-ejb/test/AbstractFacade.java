...
//-------------------------------------------
            if (Type.equals("Check")) {
                if (!S3.equals("")) {
                    S3 = S3 + " and  p.isCheck=false "
                            + " and  p.isDenied=false "
                ...
                if (!S3.equals("")) {
                    S3 = S3 + " and  p.isDenied=true ";
                } else {
                    S3 = S3 + "   p.isDenied=true ";
                }
            }

            if (Tittle.equals("") && CatagoriesName.equals("") && ProvinceName.equals("") && Type.equals("")) {
